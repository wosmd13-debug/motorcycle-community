  ...
  return (
    <LegalDocumentLayout title="이용약관">
      ...
      <section>
        ...
        <p>
          운영자는 운영상 필요에 따라 서비스 기능, 광고 위치, 일부 서비스를 변경하거나
          종료할 수 있습니다.
        </p>
      </section>
      ...
      <section>
        ...
        <ol>
          <li>
            {serviceName}는 Google AdSense 등 제3자 광고를 서비스 내에 게재할 수 있습니다.
          </li>
          <li>광고의 내용·정확성·적법성에 대한 책임은 해당 광고 제공자에게 있습니다.</li>
          <li>
            광고 클릭 및 그에 따른 거래·계약은 이용자와 광고주 사이에서 이루어지며, 이와
            관련한 책임은 이용자와 광고주에게 있습니다.
          </li>
          <li>
            광고와 관련한 개인정보 처리는{" "}
      ...
      <section>
        ...
        <p>
          회원은{" "}
          <Link href="/legal/community">커뮤니티 운영정책</Link>을 준수해야 합니다.
          운영정책 위반 시 운영자는 게시물 삭제 및 서비스 이용 제한 등 필요한 조치를 할 수
          있습니다.
        </p>
      </section>
      ...
      <section>
        ...
        <ol>
          ...
          <li>
            게시물의 내용, 법령 준수, 권리 침해 여부에 대한 법적 책임은 해당 게시물을 작성한
            회원에게 있습니다.
          </li>
          <li>
            회원이 타인의 저작권·초상권·상표권 등 권리를 침해한 경우, 그 책임은 작성한
            회원에게 있습니다.
          </li>
          <li>
            운영자는 신고 접수, 법령 위반, 약관·커뮤니티 운영정책 위반 등 정당한 사유가 있는
            경우 사전 통지 없이 게시물을 삭제하거나 노출을 제한할 수 있습니다.
          </li>
        </ol>
      </section>

      <section>
        <h2>제9조 (서비스 이용 제한 및 계정 해지)</h2>
        <p>
      ...
      <section>
        ...
        <ol>
          ...
          <li>
            운영자는 광고, 외부 링크, 회원 간 거래(중고거래·홍보 등), 오프라인 라이딩 모임으로
            인해 발생하는 문제에 대해 책임지지 않습니다.
          </li>
